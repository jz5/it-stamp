    ...
    <div class="col-sm-12 col-md-8">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <p>サイボウズ Live は無料で使えるグループウェアです。メンバーだけでファイル共有やディスカッションができる情報共有スペースを、インターネット上で簡単に作ることができます。チャット機能もあるので、リアルタイムにやりとりしたい場合にも役に立ちます。ソフトウェア開発プロジェクトの情報共有にぴったりのサービスです。</p>
