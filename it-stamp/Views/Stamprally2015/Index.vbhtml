...
<div class="row">
    <div class="col-sm-12 col-md-8">
        ...
        <h2 id="rule" style="margin-top:60px;">参加してみよう！</h2>
        <div>
        ...
        <h2 style="margin-top:60px;"><span>📅</span> スケジュール</h2>
        ...
        <h2 id="join" style="margin-top:60px;">参加コミュニティ募集中！</h2>
        <div>
